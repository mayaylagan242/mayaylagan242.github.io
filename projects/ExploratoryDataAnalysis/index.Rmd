...
date: '2021-01-01'
image: "/projects/ExploratoryDataAnalysis/index_files/figure-html/confusion_matrix-1.png"
description: ""
tags:
- Markdown syntax
- Tidying Data
...
### Select applicable variables {.unlisted .unnumbered}
...
jobs2 <- jobs %>% 
  ...
  mutate( UnemploymentRate=(UnempRate2018+UnempRate2017+UnempRate2016+UnempRate2015+UnempRate2014)/5 ) %>% 
  select(-contains("20"))
```
...
#### Count observations {.unlisted .unnumbered}
...
#### Find missing data {.unlisted .unnumbered}
...
### Percent values of employment sum to 100 {.unlisted .unnumbered}
...
### The most common county type by state {.unlisted .unnumbered}
...
### Data Preparation {.unlisted .unnumbered}
...
#### Loading Plots for PC1 and PC2 {.unlisted .unnumbered}
...
#### Loading Plots for PC3 and PC4 {.unlisted .unnumbered}
...
#### Score Plots for PC3 and PC4 {.unlisted .unnumbered}
